...
const IndexPage = () => (	
  <Layout>
   		<SEO title="Home" keywords={[`web designer`,`web developer`, `DJ`, `Misha Osinovskiy`, `San Diego`]} />
   		 	<p><span role="img" aria-label="emoji">👋👋👋</span> Hello!  My name is Misha and I would like to welcome you to my personal website.</p>
